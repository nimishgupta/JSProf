...
// TODO : Should go away, use from esprima module
var Syntax = {
...
var MONITOR_ENTRY_FUNCTION = "__$__m_entry__$__";
var MONITOR_EXIT_FUNCTION  = "__$__m_exit__$__";
...
function __decorate (f, name, line, index)
{
   ...
   */
   ...
   var m_entry_call = stringigize_function_call (MONITOR_ENTRY_FUNCTION,
                                                 [name, line, index]);
   var m_exit_call  = stringigize_function_call (MONITOR_EXIT_FUNCTION,
                                                 [name, line, index]);
   ...
   // TODO : See if parsing would produce a "Program" node type of a "BlockStatement" node type
   ...
   var new_body_ast = escodegen.parse (new_body);
